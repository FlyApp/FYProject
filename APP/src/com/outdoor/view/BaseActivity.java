...
import com.outdoor.model.PartyEntity;
...
public class BaseActivity extends Activity {
	...
	private ArrayList<PartyEntity> partyJoinList = null;
	private ArrayList<PartyEntity> partyFavoList = null;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		view_tab1 = mLi.inflate(R.layout.base_tab_index, null);
		view_tab2 = mLi.inflate(R.layout.base_tab_activity, null);
		view_tab3 = mLi.inflate(R.layout.base_tab_community, null);
		view_tab4 = mLi.inflate(R.layout.base_tab_personalinfo, null);
		...
		// view_tab2内容初始化
		/**
		 * view_tab2内容初始化 小石“活动“界面
		 */
		InitTab2Content();

		/**
		 * view_tab4内容初始化 杨少东“我的界面”
		 */
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		if (keyCode == KeyEvent.KEYCODE_BACK && event.getRepeatCount() == 0) { // 获取
			...
			if (menu_display) { // 如果 Menu已经打开 ，先关闭Menu
				...
				intent.setClass(BaseActivity.this, ExitActivity.class);
...
//		btnApply.setText("已参与");
//		btnApply.setBackgroundColor(Color.LTGRAY);
//		btnApply = null;
//	}

	// 点击关注按钮
//	public void btnConcern(View v) {
//		Button btnConcern = (Button) v.findViewById(R.id.btn_concern);
//		btnConcern.setText("已关注");
//		btnConcern.setBackgroundColor(Color.LTGRAY);
//		btnConcern = null;
//	}
	
	//点击首页中的Item项跳转到活动详情页面
	public void toDetailActivity(){
		Intent toDetailActivity = new Intent(BaseActivity.this, ItemDetailActivity.class);
		startActivity(toDetailActivity);
	}
	//点击首页中上面分类图片跳转到分类活动列表
	public void toCatagoryListActivity(View v){
		Intent intent = new Intent(BaseActivity.this, DZJSCatagActivity.class);
		startActivity(intent);
	}
	...
	public void itemClick(View v) {
		Intent todetailActivity = new Intent(BaseActivity.this,
	...
	public void btnToChat(View v) {
		Intent toChatActivity = new Intent(BaseActivity.this,
				ChatActivity.class);
	...
	public void btnLookInMap(View v) {
		Intent tolookMapActivity = new Intent(BaseActivity.this,
				LookInMapActivity.class);
		startActivity(tolookMapActivity);
	}

	// ----------------------------------Tab2设计到的点击事件----------------------------
	// ----------------------------------Tab3设计到的点击事件----------------------------
	public void toWeiCommunity(View v) {
		Intent it = new Intent( Intent.ACTION_VIEW );
	    it.setData( Uri.parse( "http://wx.wsq.qq.com/194382587") ); //这里面是需要调转的rul
	    it = Intent.createChooser( it, null );
	    startActivity( it );
	}
	// end----------------------------------Tab3设计到的点击事件----------------------------
	/**
	 * view_tab3内容初始化 杨少东“我的界面”
	 */
	// public void btnToChat(View v)
	public void start(View v) {
		Intent intent=new Intent();
		intent.setClass(BaseActivity.this, EventActivity.class );
	...
	public void toPersonSetting(View v) {
		Intent intent = new Intent();
		intent.setClass(BaseActivity.this, PersonalSettingActivity.class);
		BaseActivity.this.startActivity(intent);
	}
	...
	private void InitViewPager() {
		...
		view1 = inflater.inflate(R.layout.pager_layout1, null);
		view2 = inflater.inflate(R.layout.pager_layout2, null);
		view3 = inflater.inflate(R.layout.pager_layout3, null);
		// -----------------------------------------------
		mListView1 = (ListView) (view1.findViewById(R.id.listview_layout1));
		ActivityViewAdapter mAdapter1 = new ActivityViewAdapter(this, getData());
		mListView1.setAdapter(mAdapter1);
		mListView2 = (ListView) (view2.findViewById(R.id.listview_layout2));
		ActivityViewAdapter mAdapter2 = new ActivityViewAdapter(this, getData());
		mListView2.setAdapter(mAdapter2);
		mListView3 = (ListView) (view3.findViewById(R.id.listview_layout3));
		ActivityViewAdapter mAdapter3 = new ActivityViewAdapter(this, getData());
	...
	private void initTab2Date() {
		partyJoinList = new ArrayList<PartyEntity>();
		partyJoinList.add(new PartyEntity("旅游", "武大看樱花", "武汉大学",
				"2014-3-2 14:00"));
		partyJoinList
				.add(new PartyEntity("骑车", "环东湖骑行", "东湖", "2014-3-20 9:00"));
		partyJoinList.add(new PartyEntity("登山", "去峨嵋山看日出", "峨嵋山",
				"2014-5-1 6:00"));
		partyJoinList.add(new PartyEntity("春游", "放风筝", "呼伦贝尔大草原",
				"2014-5-2 10:00"));

		partyFavoList = new ArrayList<PartyEntity>();
		partyFavoList.add(new PartyEntity("登山", "去峨嵋山看日出", "峨嵋山",
				"2014-5-1 6:00"));
		partyFavoList.add(new PartyEntity("春游", "放风筝", "呼伦贝尔大草原",
				"2014-5-2 10:00"));
		partyFavoList.add(new PartyEntity("登山", "去峨嵋山看日出", "峨嵋山",
				"2014-5-1 6:00"));
	}
	...
	class MyOnPageChangeListener_ implements OnPageChangeListener {
		...
		public void onPageSelected(int arg0) {
			...
			Animation animation = new TranslateAnimation(one * currIndex_tab,
					one * arg0, 0, 0);
			currIndex_tab = arg0;
