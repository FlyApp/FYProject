...
"<>狗日滴<>"};
	...
	public void onClick(View v) {
		...
		//点击成员列表ImageButton
		case R.id.right_btn:
			Toast.makeText(this, "进入到显示团队成员列表的界面", Toast.LENGTH_LONG).show();
			Intent toGroupMemActivity = new Intent(ChatActivity.this, GroupMemActivity.class);
			startActivity(toGroupMemActivity);
			break;
		}
	}
	...
	public void toGroupInfoActivity(View v) { // 标题栏 返回按钮
		Intent intent = new Intent(ChatActivity.this, GroupMemActivity.class);
